...
def test_manual_layers():
    ...
    # Test ManualConv2d
    manual_conv = ManualConv2d(3, 64, kernel_size=7, stride=2, padding=3, use_builtin=False)
    ...
    # Test ManualMaxPool2d  
    manual_pool = ManualMaxPool2d(kernel_size=3, stride=3, use_builtin=False)
